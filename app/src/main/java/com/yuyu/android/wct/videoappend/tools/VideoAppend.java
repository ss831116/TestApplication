package com.yuyu.android.wct.videoappend.tools;
...
public class VideoAppend {
    ...
    public static void appendVideo(List<VideoInfo> videos, AppendVideoListener appendVideoListener) throws IOException {
        ...
        fc.close();
        appendVideoListener.append(appendVideoPath);
    }
}
